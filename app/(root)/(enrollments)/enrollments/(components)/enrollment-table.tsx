...
import { columns } from "@/app/(root)/(enrollments)/enrollments/(components)/enrollment-columns";
...
export default function EnrollmentTable() {
  ...
  const query = useMemo<EnrollmentQueryType>(() => {
