...
import { BlogFormValues, BlogSchema } from "@/validations/blog.schema";
...
export default function CreateBlogForm() {
  ...
  useEffect(() => {
    console.log(watch("og_image_url"), watch("cover_image_url"));
  }, [watch("og_image_url"), watch("cover_image_url")]);
  ...
  return (
    <Card className="w-full max-w-2xl">
      ...
      <CardContent>
        <form id="add-blog-form" onSubmit={handleSubmit(onSubmit)}>
          <FieldGroup>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="add-blog-form-title">Title</FieldLabel>
                  <Input
                    {...field}
                    id="add-blog-form-title"
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="add-blog-form-excerpt">
                    Excerpt
                  </FieldLabel>
                  <Textarea
                    {...field}
                    id="add-blog-form-excerpt"
                    aria-invalid={fieldState.invalid}
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="add-blog-form-content">
                    Content
                  </FieldLabel>
                  <Tiptap
                    value={field.value}
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="add-blog-form-status">Status</FieldLabel>
                  <NativeSelect
      ...
      <CardFooter className="justify-end gap-3">
        ...
        <Button
          ...
          form="add-blog-form"
        >
          {createBlog.isPending && <Loader2 className="animate-spin" />}
          Create Blog
        </Button>
      </CardFooter>
    </Card>
